...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 31-Jul-2024 às 12:28
...
CREATE TABLE IF NOT EXISTS `tb_aula` (
  ...
  `tema_aula` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `subtema_aula` varchar(255) DEFAULT NULL,
  `motivacao` text,
  `materia` text CHARACTER SET utf8 COLLATE utf8_general_ci,
  `id_professor` int DEFAULT NULL,
  `objetivo_geral` text,
  `tarefa` varchar(1000) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  KEY `frk_disciplina` (`id_disciplina`)
...
INSERT INTO `tb_aula` (`id_aula`, `tema_aula`, `subtema_aula`, `motivacao`, `materia`, `id_professor`, `objetivo_geral`, `tarefa`, `objetivo_especifico`, `data_aula`, `turno`, `id_turma`, `id_disciplina`) VALUES
...
CREATE TABLE IF NOT EXISTS `turma_disciplina` (
  ...
  `id_curso_turma` int DEFAULT NULL,
  PRIMARY KEY (`id_turma_disciplina`),
  KEY `turma_id` (`turma_id`),
  KEY `disciplina_id` (`disciplina_id`),
  KEY `frk_prof_id_turma` (`id_professor_turma`),
  KEY `cfrk_curso_turma` (`id_curso_turma`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb3;
...
ALTER TABLE `tb_aula`
  ...
  ADD CONSTRAINT `frk_disciplina` FOREIGN KEY (`id_disciplina`) REFERENCES `disciplinas` (`id_disciplina`) ON DELETE RESTRICT ON UPDATE RESTRICT;
...
ALTER TABLE `turma_disciplina`
  ADD CONSTRAINT `cfrk_curso_turma` FOREIGN KEY (`id_curso_turma`) REFERENCES `cursos` (`id_curso`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `frk_prof_id_turma` FOREIGN KEY (`id_professor_turma`) REFERENCES `professores` (`id_professor`) ON DELETE RESTRICT ON UPDATE RESTRICT,
