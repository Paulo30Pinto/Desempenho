...
<div class="mobile">
  ...
  <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
    ...
    <hr>
    <div class="">
      <a href="index.php" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" >
...
<div class="d-flex flex-column flex-shrink-0 p-3 text-white bg-info desktop degrad" style="width: 280px; min-height: 100vh; padding-top: 5em !important;">
    <a href="#" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
      <img class="bi me-2 pic" width="40" height="32" src="img/<?=$meusDados['foto_prof']?>"><use xlink:href="#bootstrap"/></img>
  ...
  <!--CORPO-->
<main class="container" id="page-inicio">
    <section class="py-5 text-center container bg-success text-white my-2 degrad" id="banner">
      <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto ">
        <h1 class="fw-light">Desempenho</h1>

        <p class="lead">A plataforma que veio mudar a sua vida</p>
        <p class="d-none" style="visibility: hidden;">
              <form class="d-none">
        ...
        <p>
          <div class="">
            <div class="input-group has-validation">
              ...
              <input type="text" class="form-control" id="validationServerUsername" aria-describedby="inputGroupPrepend3" placeholder="pesquisar" required>
      ...
      <div class="container py-4 rolar">
        <div class="row">
        <?php
           //   $sql = "SELECT c.nome AS classe, t.nome AS turma, cu.nome AS curso FROM professores p INNER JOIN professor_disciplina pd ON p.id_professor = pd.professor_id INNER JOIN disciplinas d ON pd.disciplina_id = d.id_disciplina INNER JOIN turma_disciplina td ON d.id_disciplina = td.disciplina_id INNER JOIN turmas t ON td.turma_id = t.id_turma INNER JOIN classes c ON t.classe_id = c.id_classe INNER JOIN cursos cu ON c.curso_id = cu.id_curso WHERE p.id_professor = $meusDados[id_professor] GROUP BY t.id_turma"; 
               $sql = "SELECT cs.nome AS curso, tm.nome AS turma, cl.nome AS classe FROM turma_disciplina td INNER JOIN professores p ON td.id_professor_turma = p.id_professor INNER JOIN cursos cs ON td.id_curso_turma = cs.id_curso INNER JOIN turmas tm ON td.turma_id = tm.id_turma INNER JOIN classes cl ON tm.classe_id = cl.id_classe WHERE td.id_professor_turma = $meusDados[id_professor] GROUP BY td.turma_id";
          ...
          <div class="col-sm-6 col-lg-4 my-2">
            <div class="card">
              ...
              <div class="card-footer text-muted text-center">
                <a href="turma.php?id_prof=<?=$meusDados['id_professor'];?>" id="turma<?=$meusDados['id_professor'];?>" class="btn btn-azul">Entrar na turma</a>
              </div>
            </div>
          </div>
          <?php 
            ...
            ?>
          <div class="col-sm-6 col-lg-4 my-2 d-none ">
            <div class="card">
              <div class="card-header">
                Classe 11ª
              </div>
              ...
              <div class="card-footer text-muted text-center">
                <a href="turma.php" class="btn btn-azul">Entrar na turma</a>
              </div>
            </div>
          </div>
